use crate::user::application::service::create_random_nickname_user_service::CreateRandomNicknameUserService;
use crate::user::application::service::find_user_by_auth_service::FindUserByAuthService;
use crate::user::infrastructure::generator::nickname_generator_impl::NicknameGeneratorImpl;
use crate::user::infrastructure::grpc::user_controller::UserGrpcController;
use crate::user::infrastructure::persistence::oracle::adapter::create_user_oracle_adapter::CreateUserOracleAdapter;
use crate::user::infrastructure::persistence::oracle::adapter::find_user_by_auth_oracle_adapter::FindUserByAuthOracleAdapter;
use crate::user::infrastructure::persistence::oracle::constraint::create_user_constraint_mapper::CreateUserConstraintMapper;
use crate::shared::infrastructure::persistence::oracle::error_parser::OracleErrorParser;
use crate::shared::infrastructure::uow::oracle::oracle_uow_manager::OracleUowManager;
use anyhow::Result;
