use crate::application::port::outbound::persistence::find_user_by_auth_repository::{
...
use crate::infrastructure::persistence::oracle::model::user::user_auth_entity::UserAuthEntity;
use crate::infrastructure::persistence::oracle::model::user::user_entity::UserEntity;
use crate::infrastructure::persistence::oracle::schema::user::{user_auths, users};
