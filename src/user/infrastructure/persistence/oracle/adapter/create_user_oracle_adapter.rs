use crate::user::application::port::outbound::persistence::create_user_repository::{
...
use crate::user::infrastructure::persistence::oracle::model::user::user_auth_entity::{
    NewUserAuthEntity, UserAuthEntity,
};
use crate::user::infrastructure::persistence::oracle::model::user::user_entity::{
    NewUserEntity, UserEntity,
};
use crate::user::infrastructure::persistence::oracle::schema::user::user_auths::dsl::user_auths;
use crate::user::infrastructure::persistence::oracle::schema::user::users::dsl::users;
