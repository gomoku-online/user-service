...
mod test {
    ...
    use user_service::user::application::port::outbound::persistence::find_user_by_auth_repository::FindUserByAuthRepository;
    ...
    use user_service::user::infrastructure::persistence::oracle::adapter::find_user_by_auth_oracle_adapter::FindUserByAuthOracleAdapter;
